var bookdatas=[
  {
    ...
    name: "雪 Q 餅 (原味盒裝) ",
    author: "約650g/盒",
    img:"https://private-user-images.githubusercontent.com/71368136/298867612-92154a8b-1887-4c58-9386-7e514ceae432.jpg?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..AnBxMJZtK15b_5rfq8_b5cU7hHuJEHKYouQf3qyb_0Q",
    price: "$580/盒",
    date: "常溫可存放2個禮拜",
    ...
    taste:"椰子",
    method:"冷藏後口感較為紮實，如欲食用，需退冰風味尤佳",
    warning:"皆為天然食材不含防腐劑、抗氧化劑，請盡早食用完畢。請置於陰涼乾燥處，避免存放在高溫或日照下。",
    hint:"台灣氣候濕熱，夏天一律以低溫宅配（運費自付）"
  },{
    name: "瑪德蓮(蜜香/可可)(不可混裝)",
    author: "8個/盒",
    ...
    taste:"蜜香/$300、可可/$300",
    method:"冷凍退冰半小時至一小時或微波1400w30秒解凍食用呈鬆軟口感，上下火200度，回烤1-2分香氣濃郁，外酥內軟",
    warning:"皆為天然食材不含防腐劑、抗氧化劑，請盡早食用完畢。請置於陰涼乾燥處，避免存放在高溫或日照下。",
    ...
    date: "常溫30天/冷凍45天",
    gradiant:"美國核桃、純棗泥、法國發酵奶油、日本海藻糖等",
    taste:"南棗核桃",
    ...
    date: "常溫30天/冷凍45天",
    gradiant:"草苺果泥、草苺乾、澳洲夏威夷豆、法國發酵奶油、日本海藻糖等",
    taste:"莓果夏威夷",
    method:"解凍需前一晚放置冷藏，隔天再放置室溫即可食用",
    warning:"皆為天然食材不含防腐劑、抗氧化劑，請盡早食用完畢。請置於陰涼乾燥處，避免存放在高溫或日照下。",
    hint:"手提包裝袋隨機"
    ...
    author: "約直徑5.5cm X 厚1.6cm/個 , 12入/盒 (凡兩種口味以上可混裝，混裝請勿線上下單，請直接私訊小編)",
    ...
    taste:"哇沙米脆片/$320、玉米濃湯脆片/$320、青蘋果抹茶/$395、野莓杏仁/$395、榛果巧克力/$395、九州黑糖/$380、川香海味夏威夷豆/$420、川香海味綜合/$395(混裝價格另計)",
    method:"開封即食",
    warning:"皆為天然食材不含防腐劑、抗氧化劑，請盡早食用完畢。請置於陰涼乾燥處，避免存放在高溫或日照下。",
    hint:"手提包裝盒隨機"
  },{
    ...
    price: "$300/袋",
    date: "常溫可存放2個禮拜",
    gradiant:"日本海藻糖、砂糖、紐西蘭奶油、楓糖漿、燕麥片、椰子粉、麵粉等",
    taste:"椰香燕麥",
    method:"開封即食",
    warning:"皆為天然食材不含防腐劑、抗氧化劑，請盡早食用完畢。請置於陰涼乾燥處，避免存放在高溫或日照下。 ",
    hint:"1.手提包裝袋隨機 2.運送過程中難免產生碰撞，可能有破損機率，介意的朋友請三思"
  },{
    name: "楓糖綜合堅果塔",
    author: "6入/盒",
