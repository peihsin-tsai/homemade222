var bookdatas=[
  /* {
    ...
    name: "草莓牛軋糖",
    author: "約200g/袋",
    img: "https://github.com/user-attachments/assets/192237ea-d3ab-449e-bb85-a460a74fc34a",
    price: "$430/袋",
    date: "常溫30天/冷藏60天",
    gradiant:"麥芽糖、寒天、日本海藻糖、蛋白霜、紐西蘭奶粉、紐西蘭無水奶油、澳洲夏威夷豆、草莓凍乾、草莓粉",
    method:"開封即食，冷藏過食用前稍退冰 口感更佳",
    taste:"草莓",
    warning:"皆為天然食材不含防腐劑、抗氧化劑，請盡早食用完畢。請置於陰涼乾燥處，避免存放在高溫或日照下。",
    hint:"提袋花色因口味而異"
    ...
    },
  {
    ...
    price: "$240/袋",
    date: "常溫可存放30天/冷藏60天",
    gradiant:"麥芽糖、砂糖、日本海藻糖、寒天、奶粉、花生、花生油、花生粉",
    method:"開封即食，冷藏過食用前稍退冰 口感更佳",
    taste:"花生",
    warning:"皆為天然食材不含防腐劑、抗氧化劑，請盡早食用完畢。請置於陰涼乾燥處，避免存放在高溫或日照下。",
    hint:"提袋花色因口味而異"
  },
  {
    ...
    price: "$240/袋",
    date: "常溫可存放30天/冷藏60天",
    gradiant:"麥芽糖、砂糖、日本海藻糖、寒天、花生、芝麻、芝麻油、芝麻粉",
    method:"開封即食，冷藏過食用前稍退冰 口感更佳",
    taste:"芝麻花生",
    warning:"皆為天然食材不含防腐劑、抗氧化劑，請盡早食用完畢。請置於陰涼乾燥處，避免存放在高溫或日照下。",
    hint:"提袋花色因口味而異"
  ...
  /*{
    name: "雪 Q 餅 (原味盒裝) ",
    author: "約650g/盒",
    img:"https://github.com/peihsin-tsai/homemade222/assets/71368136/7f61e541-dc38-449c-8adc-ee07222d83d2",
    price: "$580/盒",
    date: "常溫可存放2個禮拜/冷藏30天",
   ...
   },*/
{
    ...
    price: "$395/盒",
    date: "常溫30天",
    gradiant:"野莓杏仁：水麥芽、上白糖、海鹽、覆盆子粉、杏仁條、米香、法國發酵奶油、草莓翠粒；\n川香海味：水麥芽、三溫糖、海鹽、米香、XO醬、法國發酵奶油、辣粉、杏仁條、南瓜子、黑芝麻",
    taste:"野莓杏仁/$395、川香海味/$395",
    method:"開封即食",
    warning:"皆為天然食材不含防腐劑、抗氧化劑，請盡早食用完畢。請置於陰涼乾燥處，避免存放在高溫或日照下。",
    hint:"手提包裝盒隨機"
  },
